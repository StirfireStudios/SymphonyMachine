...
////// Lighting:
////// Emissive:
                float2 node_3817 = (float2(_time,0.0)+i.uv0);
                ...
                float node_4059 = saturate((_MainClouds_var.rgb*(((_MaskDensity*10.0)*_CloudMask1_var.rgb)*(10.0*_Density)))).r;
