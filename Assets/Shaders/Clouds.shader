...
////// Emissive:
                ...
                float3 node_228 = (((_MaskDensity*10.0)*_CloudMask1_var.rgb)*(10.0*_Density));
                float node_4059 = saturate((_MainClouds_var.rgb*node_228)).r;
