    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                v.vertex.xyz += ((o.vertexColor.g*((sin((mul(_Object2World, v.vertex).rgb+(_Speed*node_3341.g)))*0.5+0.5)*1.0).r)*float3(0,0,1));
